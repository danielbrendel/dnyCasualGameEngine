...
void CreateEntity(const Vector &in vecPos, float fRot, const string &in szIdent, const string &in szPath, const string &in szProps)
{
	...
	wavePoint.SetEntityCount(formatInt(Props_ExtractValue(szProps, "entcount")));
	wavePoint.SetWaveCount(formatInt(Props_ExtractValue(szProps, "wavecount")));
	wavePoint.SetWaveDelay(formatInt(Props_ExtractValue(szProps, "wavedelay")));
